package com.arkam.prayerreading.activities
...
import com.arkam.prayerreading.adapter.PrayerIntentionsAdapter
...
class NiatShalatActivity : AppCompatActivity() {
    ...
    var niatShalatAdapter: PrayerIntentionsAdapter? = null
    var modelBacaan: MutableList<ModelReading> = ArrayList()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        niatShalatAdapter = PrayerIntentionsAdapter(modelBacaan)
