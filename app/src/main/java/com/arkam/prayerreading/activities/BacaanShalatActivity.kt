...
import com.arkam.prayerreading.adapter.PrayerReadingAdapter
...
class BacaanShalatActivity : AppCompatActivity() {
    ...
    var bacaanShalatAdapter: PrayerReadingAdapter? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bacaanShalatAdapter = PrayerReadingAdapter(modelBacaan)
